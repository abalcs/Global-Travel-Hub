...
export const calculateMetrics = (
  ...
  for (const agentName of allAgents) {
    ...
    metrics.push({
      ...
      trips,
      quotes,
      quotesWithTripRef: quotes, // Legacy parser: assume all quotes have trip refs
      passthroughs,
      hotPasses,
      bookings,
      ...
      bookingsFromEnquiries: trips > 0 ? (bookings / trips) * 100 : 0,
      ...
      repeatQuotes: 0,
      repeatQuotesWithTripRef: 0,
      repeatBookings: 0,
      prospectTrips: trips - repeatTrips,
      prospectPassthroughs: passthroughs - repeatPassthroughs,
      prospectTpRate: (trips - repeatTrips) > 0 ? ((passthroughs - repeatPassthroughs) / (trips - repeatTrips)) * 100 : 0,
      prospectQuotes: 0,
      prospectQuotesWithTripRef: 0,
      prospectBookings: 0,
      b2bTrips,
      b2bPassthroughs,
      b2bTpRate: b2bTrips > 0 ? (b2bPassthroughs / b2bTrips) * 100 : 0,
      b2bQuotes: 0,
      b2bQuotesWithTripRef: 0,
      b2bBookings: 0,
      quotesStarted,
      potentialTQ,
      partnerTrips,
