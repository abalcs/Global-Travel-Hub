...
const mockMetrics: Metrics[] = [
  {
    ...
    repeatTpRate: 80,
    repeatQuotes: 5,
    repeatQuotesWithTripRef: 5,
    repeatBookings: 3,
    prospectTrips: 90,
    prospectPassthroughs: 32,
    prospectTpRate: 35.6,
    prospectQuotes: 45,
    prospectQuotesWithTripRef: 45,
    prospectBookings: 7,
    b2bTrips: 5,
    b2bPassthroughs: 4,
    b2bTpRate: 80,
    b2bQuotes: 2,
    b2bQuotesWithTripRef: 2,
    b2bBookings: 1,
    quotesStarted: 15,
    potentialTQ: 65,
    partnerTrips: 3,
  ...
  },
  {
    ...
    repeatTpRate: 87.5,
    repeatQuotes: 4,
    repeatQuotesWithTripRef: 4,
    repeatBookings: 2,
    prospectTrips: 72,
    prospectPassthroughs: 28,
    prospectTpRate: 38.9,
    prospectQuotes: 36,
    prospectQuotesWithTripRef: 36,
    prospectBookings: 6,
    b2bTrips: 4,
    b2bPassthroughs: 3,
    b2bTpRate: 75,
    b2bQuotes: 1,
    b2bQuotesWithTripRef: 1,
    b2bBookings: 1,
    quotesStarted: 12,
    potentialTQ: 55,
    partnerTrips: 2,
